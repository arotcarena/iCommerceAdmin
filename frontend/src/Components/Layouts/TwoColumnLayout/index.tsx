...
export const TwoColumnLayout = (props : any) => {
    ...
    const initMenu = useCallback(() => {
        ...
        const matchingItems = itemsArray.filter((x) => x.dataset.active === true);
        if(matchingItems.length > 0) {
            matchingItems.map(matchingItem => activateParentDropdown(matchingItem));
        } else {
                                                        ...
                                                        <React.Fragment key={key}>
                                                            {!subItem.isChildItem ? (
                                                                ...
                                                                <li className="nav-item">
                                                                    ...
                                                                    <Collapse className="menu-dropdown" isOpen={true} id={item.id}>
